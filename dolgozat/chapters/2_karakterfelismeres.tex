...
\begin{comment}{A szkennelő fej itt hardvert jelentene?}
\end{comment}
...
\begin{comment}{Be kell majd hivatkozni, hogy honnan van!}
\end{comment}
...
\begin{comment}{A szegmentálást úgy általában is használják kéfeldolgozásnál a régiók elkülönítéséhez.}
\end{comment}
...
\begin{comment}{Ez a rész így kicsit a levegőben van. Ha korábbi módszerek bemutatásáról van szó, akkor be kell őket hivatkozni, ha pedig új módszer/ötlet, akkor azt hangsúlyozni kell.}
\end{comment}
