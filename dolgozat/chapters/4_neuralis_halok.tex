...
\textit{Ezeket mind kiegészíteni a megfelelő CCR-el részletes leírás}
...
\textit{Ide jöhet hogy milyen hálózat paramétereket jöhetnek szóba a CCR-nél (konvolúciós rétegek, kimeneti neuronok száma). Megemlítenni a paraméterek változásának függvényébe a hálózat teljesítményét.}
...
\textit{A szakaszoknál taglalni a CCR példákat}
...
\textit{CCR-re lehet tesztelés adatot táblázatot is nézni}
...
\textit{Ide jöhet pár létező CCR-re specializált betanított hálózat}
